...
public:
	...
	virtual void attack_weapon_one(ICreature& enemy) const;
	virtual void attack_weapon_two(ICreature& enemy) const;
...
private:
	...
	/* Unarmed, WeaponOne, WeaponTwo,
		Spell, 
		RaceSpecific / ClassSpecific, 
		With(out) disadvantage, bonus attack
	*/
	virtual void attack_roll() const;
	virtual void damage_roll(/*Hand, WeaponOne, WeaponTwo, Spell, RaceSpecific, etc*/) const;

	virtual void weapon_one_attack_roll() const;
	virtual void weapon_one_damage_roll() const;
	virtual void weapon_two_attack_roll() const;
	virtual void weapon_two_damage_roll() const;
	virtual DefenseResult defend(int attack_roll) const;
	virtual void take_damage(int damage, Damage damage_type);
	virtual bool saving_throw(Ability ability) const;
	virtual bool saving_throw(Damage damage_type) const;
	// TODO: interface for spellcasters, race-specific like Dragonborn, class-specific
